    ...
    async execute(msg, args, con, linkargs, client, catchErr) {
        try {
            ...
            let { body } = await superagent
                .get("https://api.jikan.moe/v3/user/" + maluser).catch(err => {
                    gen.delete();
                    return catchErr(err, msg, `${module.exports.name}.js`, "Sorry, I couldn't find that user\nMAL servers may temporarily down or blocking me right now. Feel free to try again")
                });
            try {
