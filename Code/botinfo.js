...
const yui = { username: 'Yui', id: '280497242714931202', prefix: 'yui or y!', excmd: 'kiss', ss: 'https://discord.com/invite/h4bGxV', web: 'https://discordyui.net/', cmdweb: true, cmdlink: 'https://discordyui.net/commands', nsfw: false }
const ygg = { username: 'Yggdrasil', id: '247283454440374274', prefix: '--', excmd: 'userphone', ss: 'https://discord.com/invite/qVGuRaR', web: 'https://ygg.fun/', cmdweb: true, cmdlink: 'https://ygg.fun/', nsfw: false}
...
module.exports = {
    ...
    execute(msg, args, con, linkargs, client, catchErr) {
        try {
            let botids = [mee6.id, corona.id, idlerpg.id, notsobot.id, yag.id, myuu.id, nadeko.id, ecchi.id, owo.id, karuta.id, rythm.id, tatsu.id, waifu.id, aki.id, mirai.id, memer.id, mudae.id, mudamaid.id, yui.id, ygg.id]
            let botlist = [mee6, corona, idlerpg, notsobot, yag, myuu, nadeko, ecchi, owo, karuta, rythm, tatsu, waifu, aki, mirai, memer, mudae, mudamaid, yui, ygg]
